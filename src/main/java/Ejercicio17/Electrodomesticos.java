...
public class Electrodomesticos {
    ...
    public double precioFinal() {
        ...
        switch (this.consumoEnergetico) {
            case 'A':
                VarlorconsumoEnergetico = 100;
                break;
            case 'B':
                VarlorconsumoEnergetico = 80;
                break;
            case 'C':
                VarlorconsumoEnergetico = 600;
                break;
            case 'D':
                VarlorconsumoEnergetico = 50;
                break;
            case 'E':
                VarlorconsumoEnergetico = 30;
                break;
            case 'F':
                VarlorconsumoEnergetico = 10;
                break;
        }
