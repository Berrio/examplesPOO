...
//        System.out.println("Juego con mas Horas : "+juegoConMasHoras.toString());
    ...
    public void ejercicio12(){
        ...
        String palabra1 = scaner.nextLine();
        System.out.println("ingrese la palabra 2");
        String palabra2 = scaner.nextLine();

        if (palabra1.equalsIgnoreCase(palabra2)) {
            System.out.println("Las palabras ingresadas son exactas");
        } else {
            String difference = StringUtils.difference(palabra1, palabra2);
            System.out.println("no son iguales,esta es la diferencia: " + difference);
        }
    }
